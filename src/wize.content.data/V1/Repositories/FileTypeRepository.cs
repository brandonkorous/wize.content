...
{
    public class FileTypeRepository : RepositoryBase<int, FileType>, IFileTypeRepository
    {
        public FileTypeRepository(ILogger<IFileTypeRepository> logger, WizeContext context) : base(logger, context)
        {
