...
{
    public class LinkRepository : RepositoryBase<int, Link>, ILinkRepository
    {
        public LinkRepository(ILogger<ILinkRepository> logger, WizeContext context) : base(logger, context)
        {
