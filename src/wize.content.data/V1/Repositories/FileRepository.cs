...
{
    public class FileRepository : RepositoryBase<int, File>, IFileRepository
    {
        public FileRepository(ILogger<IFileRepository> logger, WizeContext context) : base(logger, context)
        {
